    ...
    public static void main(String[] args) throws IOException, FileNotFoundException {
        ...
        default:
            throw new IllegalArgumentException(
            	"Usage : GCVT -g <fichier> <taille> <valeur max> (pour générer)\n"
              + "     ou GCVT -c <fichier1> <fichier2> <début> (pour comparer)\n" 
              + "     ou GCVT -v <fichier1> <indice début> <indice fin> (pour visualiser)\n" );
        }
    }
}